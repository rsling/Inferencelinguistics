...
\newcommand{\CellBlack}{\cellcolor{black}}
...
\newcounter{exerccc}
\counterwithin{exerccc}{chapter}

\newenvironment{exercises}
{%
\clearpage
\begin{tblscolorenviron}{lightgray}{Exercises for Chapter~\thechapter}
}{%
\end{tblscolorenviron}%
}

\newcommand{\exercise}[1]{%
  \stepcounter{exerccc}%
  \vspace{\baselineskip}
  \noindent\textbf{(\arabic{exerccc})}\label{exer:#1}~%
}
...
\newcommand{\Key}[1]{\index{#1}\textcolor{black}{\textit{#1}}%
...
\newcommand{\Nom}{\Sub{Nom}}
\newcommand{\Akk}{\Sub{Acc}}
\newcommand{\Dat}{\Sub{Dat}}
\newcommand{\Gen}{\Sub{Gen}}

\newcommand{\xsample}{\ensuremath{\mathbf{x}}}
\newcommand{\xcounts}{\ensuremath{\mathbf{c}}}
\newcommand{\xmode}{\ensuremath{\dot{\xsample}}}
\newcommand{\xmedian}{\ensuremath{\widetilde{\xsample}}}
\newcommand{\xmean}{\ensuremath{\bar{\xsample}}}

\newcommand{\ysample}{\ensuremath{\mathbf{y}}}
\newcommand{\ymode}{\ensuremath{\dot{\ysample}}}
\newcommand{\ymedian}{\ensuremath{\widetilde{\ysample}}}
\newcommand{\ymean}{\ensuremath{\bar{\ysample}}}

\newcommand{\zsample}{\ensuremath{\mathbf{z}}}
\newcommand{\zmode}{\ensuremath{\dot{\zsample}}}
\newcommand{\zmedian}{\ensuremath{\widetilde{\zsample}}}
\newcommand{\zmean}{\ensuremath{\bar{\zsample}}}

\newcommand{\prm}{\ensuremath{^{\prime}}}

\newcommand{\ssigma}{SE}
\newcommand{\confint}{EI}

\newcommand{\Argh}{\textcolor{textred}{\Stopsign\ }}

\newcommand{\dink}[1]{\raisebox{-1pt}{\ding{#1}}}
