...
the.lwd <- 3
the.pchs <- c(20)
the.cols <- c("darkgreen", "darkblue", "darkred", "yellow")
the.lightcols <- c(lighten(the.cols[1], 0.5), "lightblue", lighten(the.cols[3], 0.25), "lightyellow")
...
shade <- function(x, y, from, to, col, border = F) {
