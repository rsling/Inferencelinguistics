...
The \alert{effect size} for Fisher's Exact Test is a measure of how strongly two variables interact.
...
\begin{equation}
  \binom43\cdot\binom41=\frac{4!}{1!3!}\frac{4!}{3!1!}=\frac{24}{6}\cdot\frac{24}{6}=4\cdot 4=16
  \label{eq:threefour}
\end{equation}
...
\begin{center}\begin{math}
  \binom44\binom40+\binom43\binom41=1\cdot 1+4\cdot 4=1+16=17
\end{math}\end{center}
...
\begin{center}\begin{math}
  \frac{\binom{890}{90}\binom{210}{10}}{\binom{1,100}{100}}+\frac{\binom{890}{91}\binom{210}{9}}{\binom{1,100}{100}}+\dots+\frac{\binom{890}{100}\binom{210}{0}}{\binom{1,100}{100}}\approx 0.008
\end{math}\end{center}
...
\begin{center}\begin{math}
  \frac{\binom{869}{69}\binom{231}{31}}{\binom{1,100}{100}}+\frac{\binom{869}{68}\binom{231}{32}}{\binom{1,100}{100}}+\dots\frac{\binom{869}{0}\binom{231}{100}}{\binom{1,100}{100}}\approx 0.009
\end{math}\end{center}
...
\section{Sample Size and Effect Size}\label{sec:sampleeffectsize}
...
Then, we informally introduce the notion of the effect size, to which we will return repeatedly in later chapters, very crucially in Chapter~\ref{sec:powerseverity}.
...
\begin{center}
\begin{math}
  \frac{\binom{40}{30}\binom{40}{10}}{\binom{80}{40}}+\frac{\binom{40}{31}\binom{40}{9}}{\binom{80}{40}}+\dots+\frac{\binom{40}{40}\binom{40}{0}}{\binom{80}{40}}\approx 7.44\cdot 10^{-6}
\end{math}
\end{center}
...
\section{The Distribution of P-Values}\label{sec:pdist}
