...
\begin{table}
  ...
  \multicolumn{2}{c|}{}  & \textbf{Active} & \textbf{Passive} & \\
  \hline
  \multirow{2}{*}{\textbf{Verb}} & \textbf{\textit{arrest}} & \CellBlue 69 & \CellGreen 31 & \multicolumn{1}{c|}{\Dim\textbf{100}} \\
  \cline{2-5}
  & \textbf{Other}    & 800 & 200 & \multicolumn{1}{c|}{\textbf{1,000}} \\
  \hline
  \multicolumn{2}{c|}{}  & \CellBlue\textbf{869} & \CellGreen\textbf{231} & \multicolumn{1}{c|}{\Dim \textbf{1,100}} \\
  \cline{3-5}
  \end{tabular}
...
\begin{table}
  ...
  \multicolumn{2}{c|}{}  & \textbf{Tea-First} & \textbf{Milk-First} & \\
  \hline
  \multirow{2}{*}{\textbf{Bristow}} & \textbf{Tea-First}     & \CellBlue 30 & 10 \CellGreen & \multicolumn{1}{c|}{\Dim\textbf{40}} \\
  \cline{2-5}
  & \textbf{Milk-First}    & 10 & 30 & \multicolumn{1}{c|}{\textbf{40}} \\
  \hline
  \multicolumn{2}{c|}{}  & \CellBlue \textbf{40} & \CellGreen \textbf{40} & \multicolumn{1}{c|}{\Dim \textbf{80}} \\
  \cline{3-5}
  \end{tabular}
  \caption{Results of a Tea-Tasting Marathon}
  \label{tab:teamarathon}
\end{table}
...
Many practical introductions to statistics blur the distinction by simply stating that ``\textit{both a large sample size and a large effect strength make it easier to obtain a low p-value}''.
...
Argh!
It's clearly not itself a probability.
