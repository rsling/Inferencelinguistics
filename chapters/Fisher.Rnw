...
It is no grounds to reject the hypothesis that Muriel Bristow is just guessing.%
\footnote{Incidentally, she allegedly chose all four cups correctly when the experiment was conducted.
Impressive!}
