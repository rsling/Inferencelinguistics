...
Under such an approach, do you get more, less, or a constant number of significant results when the actual effect strength increases (all other things being equal) in the long run?
