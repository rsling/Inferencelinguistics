...
<<xyhist, fig.cap=paste0("Histograms and density plots of two different samples of a numeric variable with n=100"), echo=F, fig.pos="t", out.width="100%", cache=T>>=
...
<<varxandyvar, echo=F, cache=T, out.width="85%", results="asis">>=
  numsumxy <- matrix(
